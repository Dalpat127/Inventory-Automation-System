<%@ Page Title="" Language="C#" MasterPageFile="~/inventory.master" AutoEventWireup="true" CodeFile="Sell.aspx.cs" Inherits="Sell" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="background-color: #FFCC66; padding: 25px; width: 95%;">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="sell id" Visible="False"></asp:Label>
            </td>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="style45" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT DISTINCT [cid] FROM [new_customer]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
        ...
        <tr class="style36">
            ...
            <td class="style45" 
                ...
                style="border-style: solid; border-top-width: 1px; border-right-width: 1px; border-color: #800000; border-collapse: collapse;">
                <asp:FileUpload ID="FileUpload1" runat="server" Height="30px" Width="330px" />
            </td>
        </tr>
        <tr class="style36">
            <td class="style44" 
        ...
        <tr class="style36">
            ...
            <td class="style45" 
                ...
                style="border-style: solid; border-top-width: 1px; border-right-width: 1px; border-color: #800000; border-collapse: collapse;">
                <asp:FileUpload ID="FileUpload4" runat="server" Height="30px" 
                    style="margin-bottom: 0px" Width="330px" />
            </td>
        </tr>
        <tr class="style36">
            <td class="style44" 
        ...
        <tr class="style36">
            <td class="style40" colspan="2">
                <asp:Button ID="Button13" runat="server" Height="37px" 
                    ...
                    Text="Sell" Width="169px" onclick="Button13_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
